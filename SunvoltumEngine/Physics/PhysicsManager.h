...
// PhysicsManager НЕ экспортируется через LibSunvoltum —
// он полностью внутренний для LibSunvoltum.dll и никогда не используется
...
namespace Sunvoltum {
    ...
    private:
        ...
        // Нет LibSunvoltum на классе → нет C4251.
